...
// output of fn1.
//
// Compose is roughly the opposite of Curry. Where Curry
// "expands" one function into two, Compose "compresses"
// two functions down into one.
//
// Example usage:
//
//	composedFn := Compose(
...
// Curry takes one function with two parameters and
// returns a single-parameter function that returns a
// second single parameter function, which then
...
// "compresses" two functions down into one.
